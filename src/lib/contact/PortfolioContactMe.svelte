<script>
	...
	import { SOCIAL_MEDIA_PROFILES } from '../variables';
...
<div class="flex flex-col gap-2 font-mono" style="color: var(--text-primary);">
	<div class="flex flex-col md:flex-row items-center justify-center">
		...
		<div>
			<div
				class="text-center text-2xl sm:text-3xl font-bold tracking-wider pb-4"
			...
			<div class="my-2 flex flex-col items-center justify-center gap-6">
				{#each SOCIAL_MEDIA_PROFILES as profile}
					...
					>
						...
						<div class="text-center text-sm font-bold ml-2" style="color: var(--text-secondary);">
							{profile.description}
						</div>
					</a>
				{/each}
		...
		<!-- Divider -->
		<!-- Visible only in row mode -->
		<div class="hidden md:block w-px h-60 bg-gray-500 mx-4" />
		<div class="block md:hidden h-px w-80 bg-gray-300 my-4" />
